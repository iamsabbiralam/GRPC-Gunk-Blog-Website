...
func (x *GetCategoryResponse) GetCategoryName() string {
	if x != nil {
...
var file_proto_category_category_proto_rawDesc = []byte{
	...
	0x0d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x24,
	...
	0x52, 0x02, 0x49, 0x44, 0x22, 0x61, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49,
	0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x49, 0x44, 0x12, 0x22, 0x0a, 0x0c, 0x43,
	...
	,
...
var file_proto_category_category_proto_goTypes = []interface{}{
	(*GetCategoryRequest)(nil),   // 0: protoCategory.GetCategoryRequest
	(*GetCategoryResponse)(nil),  // 1: protoCategory.GetCategoryResponse
	(*GetCategoriesRequest)(nil), // 2: protoCategory.GetCategoriesRequest
}
var file_proto_category_category_proto_depIdxs = []int32{
	0, // 0: protoCategory.CategoryService.GetCategory:input_type -> protoCategory.GetCategoryRequest
	2, // 1: protoCategory.CategoryService.GetCategories:input_type -> protoCategory.GetCategoriesRequest
	1, // 2: protoCategory.CategoryService.GetCategory:output_type -> protoCategory.GetCategoryResponse
	1, // 3: protoCategory.CategoryService.GetCategories:output_type -> protoCategory.GetCategoryResponse
...
type CategoryServiceClient interface {
	...
	GetCategories(ctx context.Context, in *GetCategoriesRequest, opts ...grpc.CallOption) (CategoryService_GetCategoriesClient, error)
}
...
func (c *categoryServiceClient) GetCategory(ctx context.Context, in *GetCategoryRequest, opts ...grpc.CallOption) (*GetCategoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protoCategory.CategoryService/GetCategory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) GetCategories(ctx context.Context, in *GetCategoriesRequest, opts ...grpc.CallOption) (CategoryService_GetCategoriesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CategoryService_serviceDesc.Streams[0], "/protoCategory.CategoryService/GetCategories", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceGetCategoriesClient{stream}
...
type CategoryService_GetCategoriesClient interface {
	Recv() (*GetCategoryResponse, error)
	grpc.ClientStream
}

type categoryServiceGetCategoriesClient struct {
	grpc.ClientStream
}

func (x *categoryServiceGetCategoriesClient) Recv() (*GetCategoryResponse, error) {
...
type CategoryServiceServer interface {
	...
	GetCategories(*GetCategoriesRequest, CategoryService_GetCategoriesServer) error
}
...
func (*UnimplementedCategoryServiceServer) GetCategories(*GetCategoriesRequest, CategoryService_GetCategoriesServer) error {
...
func _CategoryService_GetCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protoCategory.CategoryService/GetCategory",
	}
...
func _CategoryService_GetCategories_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetCategoriesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CategoryServiceServer).GetCategories(m, &categoryServiceGetCategoriesServer{stream})
}

type CategoryService_GetCategoriesServer interface {
	Send(*GetCategoryResponse) error
	grpc.ServerStream
}

type categoryServiceGetCategoriesServer struct {
	grpc.ServerStream
}

func (x *categoryServiceGetCategoriesServer) Send(m *GetCategoryResponse) error {
	return x.ServerStream.SendMsg(m)
}

var _CategoryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "protoCategory.CategoryService",
